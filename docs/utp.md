---
title: "uTP"
source: "https://libtorrent.org/utp.html"
---
...
The congestion controller in uTP is called [LEDBAT](https://datatracker.ietf.org/doc/draft-ietf-ledbat-congestion/), which also is an IETF working
...
For any uTP (or [LEDBAT](https://datatracker.ietf.org/doc/draft-ietf-ledbat-congestion/)) implementation, there is a target delay. This is the
amount of delay that is acceptable, and is in fact targeted for the connection.
The target delay is defined to 25 ms in [LEDBAT](https://datatracker.ietf.org/doc/draft-ietf-ledbat-congestion/), uTorrent uses 100 ms and
libtorrent uses 75 ms. Whenever a delay measurement is lower than the target,
cwnd is increased proportional to (target\_delay - delay). Whenever the measurement
is higher than the target, cwnd is decreased proportional to (delay - target\_delay).
...
[![img/cwnd_thumb.png](img/cwnd_thumb.png)](cwnd.png)
...
[![img/delays_thumb.png](img/delays_thumb.png)](delays.png)
...
[![img/our_delay_base_thumb.png](img/our_delay_base_thumb.png)](our_delay_base.png)
...
is quite significant, especially if your target delay is 25 ms (as in the [LEDBAT](https://datatracker.ietf.org/doc/draft-ietf-ledbat-congestion/) spec).
...
presentation at [IPTPS10](http://www.usenix.org/event/iptps10/tech/slides/cohen.pdf).
