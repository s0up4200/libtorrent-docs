---
title: "BitTorrent extension for arbitrary DHT store"
source: "https://libtorrent.org/dht_store.html"
---
...
get\_peers and announce\_peer.

Responses to get should always include nodes and nodes6. Those
fields have the same semantics as in its get\_peers response. It should also
include a write token, token, with the same semantics as int get\_peers.
...
get\_peers and announce\_peer, when requesting an item and to write an
item respectively.
...
not exceed MAX\_INT64, (i.e. 0x7fffffffffffffff. A client MAY reject any
...
The error message (as specified by [BEP5](https://www.bittorrent.org/beps/bep_0005.html)) looks like this:
...
In addition to the error codes defined in [BEP5](https://www.bittorrent.org/beps/bep_0005.html), this specification defines
