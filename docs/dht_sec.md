---
title: "BitTorrent DHT security extension"
source: "https://libtorrent.org/dht_sec.html"
---
...
![img/ip_id_v4.png](img/ip_id_v4.png)
![img/ip_id_v6.png](img/ip_id_v6.png)
...
![img/complete_bit_prefixes.png](img/complete_bit_prefixes.png)
...
![img/hash_distribution.png](img/hash_distribution.png)

The source code for these tests can be found [here](https://github.com/arvidn/hash_complete_prefix).
...
original DHT specification only announce\_peer stores data in the network,
