---
title: "introduction"
source: "https://libtorrent.org/features-ref.html"
---
...
[BEP 52](https://www.bittorrent.org/beps/bep_0052.html)). BitTorrent V2 introduces a new format for .torrent files, which generally
...
* [plugin](reference-Plugins.md#plugin) interface for implementing custom bittorrent extensions
  without having to modify libtorrent
* supports trackerless torrents (using the Mainline kademlia DHT protocol) with
  some [DHT extensions](dht_extensions.md). [BEP 5](https://www.bittorrent.org/beps/bep_0005.html).
* supports the bittorrent [extension protocol](extension_protocol.md). See [extensions](manual-ref.md#extensions). [BEP 10](https://www.bittorrent.org/beps/bep_0010.html).
* supports the uTorrent metadata transfer protocol [BEP 9](https://www.bittorrent.org/beps/bep_0009.html) (i.e. magnet links).
...
* multi-tracker extension support (supports both strict [BEP 12](https://www.bittorrent.org/beps/bep_0012.html) and the
  uTorrent interpretation).
* tracker scrapes
* supports lt\_trackers extension, to exchange trackers between peers
* [HTTP seeding](manual-ref.md#http-seeding), as specified in [BEP 17](https://www.bittorrent.org/beps/bep_0017.html) and [BEP 19](https://www.bittorrent.org/beps/bep_0019.html).
* supports the UDP-tracker protocol. ([BEP 15](https://www.bittorrent.org/beps/bep_0015.html)).
* supports the no\_peer\_id=1 extension that will ease the load off trackers.
* supports the compact=1 tracker parameter.
* super seeding/initial seeding ([BEP 16](https://www.bittorrent.org/beps/bep_0016.html)).
* private torrents ([BEP 27](https://www.bittorrent.org/beps/bep_0027.html)).
* upload-only extension ([BEP 21](https://www.bittorrent.org/beps/bep_0021.html)).
* support for IPv6, including [BEP 7](https://www.bittorrent.org/beps/bep_0007.html) and [BEP 24](https://www.bittorrent.org/beps/bep_0024.html).
...
* supports the Magnet URI extension - Select specific file indices for
  download. [BEP 53](https://www.bittorrent.org/beps/bep_0053.html).
...
* fast resume support, a way to avoid the costly piece check at the
  start of a resumed torrent. Saves the storage state, piece\_picker state
...
* a high quality uTP implementation ([BEP 29](https://www.bittorrent.org/beps/bep_0029.html)). A transport protocol with
  delay based congestion control. See separate [article](utp.md).
...
![img/write_disk_buffers.png](img/write_disk_buffers.png)
...
![img/read_disk_buffers.png](img/read_disk_buffers.png)
...
(inheriting from the [disk\_interface](reference-Custom_Storage.md#disk_interface)) that avoids the unnecessary step of mapping
...
libtorrent also comes with [python bindings](python_binding.md).
