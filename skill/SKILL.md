...
<!--
NOTE: This is a reference copy. The actively maintained version lives in:
  https://github.com/soup/skills (skills/libtorrent/)

This copy may fall behind the upstream version. The key difference you'll
need to change: the docs path below is hardcoded to the original author's
local clone. Update it to wherever you cloned this repo.
-->
...
**Update this path to match your local clone of the libtorrent-docs repo:**
